...
## ⚠️ 关键规则
- **兼顾数量与质量**：从采集到的新闻中选出 5-8 条最有价值的，既不要只推1-2条，也不要凑数
- **放宽相关性判断**：涉及股票、经济、央行、政策、公司财报、行业动态、贸易、能源、科技公司、房地产、黄金、大宗商品的新闻都算资本市场相关
- **区分重要程度**：真正重磅的标"高"、一般重要的标"中"、值得关注的标"低"，用 impact_level 区分而非直接丢弃
- 新闻不足 5 条时全部输出，超过 8 条时取 TOP8
...
- impact_market 是数组，可包含多个市场: "A股" / "美股" / "港股" / "黄金"
- 黄金市场关注：国际金价走势、美联储货币政策、地缘政治、通胀数据、央行购金动态
- 确保输出是合法 JSON，不要有尾随逗号
- title 和 summary 都使用中文
- **top10 数组目标 5-8 条，只推送真正有市场影响的新闻**"""
